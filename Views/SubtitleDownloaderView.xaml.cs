...
namespace SubtitlesDownloaderWPF.Views
{
    ...
    public partial class SubtitleDownloaderView : Window
    {
        ...
        /// TODO: Pass in argument the strategy we wish to use
        /// </summary>
        public SubtitleDownloaderView()
        {
            ...
            var bingAccountKeyRequestor = new BingAccountKeyRequestor();
            if (bingAccountKeyRequestor.ShowDialog() != true)
                Environment.Exit(0);

            _searchStrategy = new BingSearchStrategy(bingAccountKeyRequestor.BingAccountKey);
            _timeout = 10000;
